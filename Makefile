...
#    Updated: 2024/05/16 14:40:36 by yizhang       ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
ifndef $(shell find $(OBJ_DIR) -maxdepth 1 -name $(OBJ_DIR))
	DIR = obj obj/cgi obj/config obj/helpers obj/request obj/response obj/server obj/status obj/exceptions obj/epoll
endif
